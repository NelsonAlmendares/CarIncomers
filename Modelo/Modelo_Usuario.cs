...
namespace Modelo
{
    ...
    {
        public static int InsertData (string Nombre, string Apellido, string Documento, string Password, int Edad, string Telefono, string Celular, string Licencia, string Fecha, int EstadoUsuario, int TipoUsuario, string Usuario) 
        {
